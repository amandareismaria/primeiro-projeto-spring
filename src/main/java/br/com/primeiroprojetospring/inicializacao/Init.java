...
public class Init implements ApplicationListener<ContextRefreshedEvent> {
	...
	public void onApplicationEvent(ContextRefreshedEvent event) {
		...
		usuario.setNomeCompleto("Jon Snow");
		...
		usuario2.setNomeCompleto("Aegon Targaryen");
		usuario2.setLogin("aegonT");
		...
		usuario3.setNomeCompleto("Cersei Lannister");
		usuario3.setLogin("lannisterC");
